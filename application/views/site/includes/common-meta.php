...
<link rel="shortcut icon" href="<?= base_url(($contact_data[PROFILE_FAVICON_FIELD] ?? null) ? (PROFILE_LOGO_UPLOAD_PATH . $contact_data[PROFILE_FAVICON_FIELD]) : LOGO_IMG_MIN) ?>" type="image/x-icon">
<title><?= $contact_data['company_name'] ?></title>
