...
<head>
    ...
    foreach ($styles ?? [] as $style) {
        $this->load->view("email/css/" . $style);
    }
    ?>
                                    ...
                                    <div style="width: 100% !important;">
                                        ...
                                        <div style="padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                                            ...
                                            <table id="u_content_image_1" style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:15px 20px;font-family:'Lato',sans-serif;" align="left">

                                                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                <tr>
                                                                    <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
                                                                        <img align="center" border="0" src="<?= base_url($header_img ?? (PROFILE_LOGO_UPLOAD_PATH . $profile_config[PROFILE_LOGO_FIELD])) ?>" alt="<?= $header_brand ?? $profile_config['company_name'] ?>" title="<?= $header_brand ?? $profile_config['company_name'] ?>" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;float: none;width: auto;max-width: 60%; height: auto; max-height: 80px;" class="v-src-width v-src-max-width" />
                                                                    </td>
                                                                </tr>
                                                            </table>
